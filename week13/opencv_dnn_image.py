...
model = cv.dnn.readNetFromTensorflow(model='/home/pavlov/Project/python/week13/frozen_inference_graph.pb',\
                        config='/home/pavlov/Project/python/week13/ssd_mobilenet_v2_coco_2018_03_29.pbtxt')

image = cv.imread('/home/pavlov/Project/python/week13/person.jpeg')
...
cv.imwrite('/home/pavlov/Project/python/week13/person_result.jpeg', image)
cv.waitKey(0)
